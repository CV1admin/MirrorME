...
const Sidebar: React.FC = () => {
  const links = [
    ...
    { to: '/thin-line-theory', label: 'Thin Line Theory', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
    )},
    { to: '/civilisation-dashboard', label: 'Civilisation Dashboard', icon: (
    ...
    { to: '/quantum-hub', label: 'Quantum Hub', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v18m9-9H3m14.95-6.95L6.05 17.95m11.9 0L6.05 6.05" /></svg>
    )},
  ];
    ...
    <nav className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col p-4 gap-2">
      <div className="px-4 py-4 mb-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="font-bold text-xl">Civilisation.One</span>
        </div>
        <p className="text-[10px] uppercase tracking-tighter text-slate-500 font-bold">Personal + Theory + Civilisation Layers</p>
      </div>
