...
const QuantumDashboard: React.FC<QuantumDashboardProps> = ({ node, onClose }) => {
  ...
  return (
    <aside className="fixed right-4 top-20 z-50 w-80 max-w-[24rem] rounded-2xl border border-cyan-400/50 bg-zinc-950/95 p-6 text-white shadow-2xl shadow-cyan-500/20 backdrop-blur-xl transition-transform duration-200 md:right-6 md:top-24 md:w-96">
