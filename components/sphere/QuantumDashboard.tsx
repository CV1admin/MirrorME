...
const QuantumDashboard: React.FC<QuantumDashboardProps> = ({ node, onClose }) => {
  ...
  return (
    <aside className="fixed right-6 top-24 z-50 w-96 rounded-2xl border border-cyan-400/50 bg-zinc-950/95 p-6 text-white shadow-2xl shadow-cyan-500/20 backdrop-blur-xl">
